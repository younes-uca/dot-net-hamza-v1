...
export class AchatViewAdminComponent extends AbstractViewController<AchatDto, AchatCriteria, AchatAdminService> implements OnInit {
    ...
    constructor(private achatService: AchatAdminService, private clientService: ClientAdminService, private achatItemService: AchatItemAdminService, private produitService: ProduitAdminService){
        super(achatService);
    }
